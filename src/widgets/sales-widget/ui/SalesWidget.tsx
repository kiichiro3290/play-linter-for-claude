...
export const SalesWidget = () => {
  ...
  const totalRevenue = salesData.reduce((total, sale) => total + sale.revenue, 0);
    ...
    <Card title="Sales Overview">
      ...
      <div className="space-y-3">
        ...
        {salesData.slice(0, 3).map((sale) => (
          <div key={sale.id} className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700 last:border-0">
            <div>
